...
public class CatalogoPlan {
    ...
    public CatalogoPlan(int catalogoPlanId, String nombreCatalogoPlan, double precioMensualCatalogoPlan, int limiteSesionesMes, boolean incluyeDiagnostico, boolean incluyeActividades, boolean permiteDerivacion, String descripcionCatalogoPlan, boolean activoCatalogoPlan) {
    ...
    public int getCatalogoPlanId() {
        return catalogoPlanId;
    }

    public void setCatalogoPlanId(int catalogoPlanId) {
        this.catalogoPlanId = catalogoPlanId;
    }
